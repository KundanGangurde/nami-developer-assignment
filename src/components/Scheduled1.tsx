...
export type Scheduled1Type = {
  /** Style props */
  propOverflowX?: CSSProperties["overflowX"];
};

const Scheduled1: FunctionComponent<Scheduled1Type> = ({ propOverflowX }) => {
  const gUC278Style: CSSProperties = useMemo(() => {
    return {
  ...
  return (
    <div className="self-stretch flex flex-row items-start justify-start max-w-full text-left text-xs text-text-text-dark font-button-button-text-secondary">
      <div className="flex-1 rounded-regular bg-background-background-primary box-border flex flex-col items-start justify-start p-2 gap-[12px] max-w-full border-[0.5px] border-solid border-default-grey">
        <div className="self-stretch h-5 flex flex-row items-start justify-start">
          <div className="self-stretch flex flex-row items-start justify-start py-0 pr-5 pl-0 gap-[4px]">
            <div
              className="self-stretch rounded bg-background-grey-light flex flex-row items-start justify-start py-0.5 px-1 gap-[5px]"
              style={gUC278Style}
            >
              <img
