...
const TaskHistory: FunctionComponent = () => {
  return (
    <div className="self-stretch rounded-regular bg-background-background-primary box-border flex flex-col items-start justify-start p-2 gap-[12px] max-w-full shrink-0 text-left text-xs text-text-text-dark font-button-button-text-secondary border-[0.5px] border-solid border-default-grey">
      <div className="self-stretch flex flex-row items-start justify-start [row-gap:20px] mq450:flex-wrap">
        <div className="flex-1 flex flex-row items-start justify-start gap-[4px] min-w-[156px]">
          <div className="h-[21.5px] flex-1 flex flex-col items-start justify-start pt-[1.5px] px-0 pb-0 box-border">
          ...
          <button className="cursor-pointer [border:none] py-small1 px-regular1 bg-accent-accent-success flex-[0.7895] rounded-xl flex flex-row items-start justify-start whitespace-nowrap hover:bg-mediumseagreen">
            <div className="relative text-xs font-medium font-text-description-text text-background-background-primary text-left inline-block min-w-[60px]">
              On - Time
            </div>
          </button>
        ...
        <div className="w-[104px] flex flex-col items-start justify-start pt-[1.5px] px-0 pb-0 box-border text-background-background-primary">
          <div className="self-stretch flex flex-row items-start justify-end">
            <div className="rounded-xl bg-accent-accent-success flex flex-row items-start justify-start py-[2.5px] px-regular1 gap-[4px]">
              <div className="relative font-semibold inline-block min-w-[8px]">
                5
              </div>
      ...
      <div className="w-[319px] rounded-regular1 bg-default-color-primary hidden flex-row items-center justify-center py-regular1 px-mediium box-border gap-[8px] whitespace-nowrap text-default-color-primary-light">
        <img className="h-small w-small relative" alt="" src="/guc153-10.svg" />
